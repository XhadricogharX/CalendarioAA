      ...
      <div className="flex flex-col items-center gap-4 sm:flex-row sm:items-center">
        {qr ? (
          <img
            ...
            className="h-32 w-32 shrink-0 rounded-xl border border-hairline bg-white"
          />
        ) : (
          <div className="grid h-32 w-32 shrink-0 place-items-center rounded-xl border border-hairline text-content/40">
